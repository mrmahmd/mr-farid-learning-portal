...
export function AuthenticatedCourse({ curriculum }: { curriculum: Curriculum }) {
  ...
  if (embeddedApp) {
    const cacheVersion = curriculum.slug === "english-primary-1" ? "&v=20260718-3" : curriculum.slug === "english-primary-4" ? "&v=20260717-12" : curriculum.slug === "connect-plus-primary-4" ? "&v=20260717-10" : "";
