...
const translations: Record<string, string> = {
  ...
  "Games": "الألعاب",
  "Play & Learn": "العب وتعلّم",
  "Free English grammar games": "ألعاب قواعد اللغة الإنجليزية المجانية",
  "Grammar Goal Champions": "أبطال ركلات القواعد",
  "Train your English grammar with football challenges.": "تدرّب على قواعد اللغة الإنجليزية من خلال تحديات كرة القدم.",
  "Free for everyone": "مجانًا للجميع",
  "Open Game": "ابدأ اللعب",
  "A free space for every young learner to practise English, play with confidence, and enjoy learning.": "مساحة مجانية لكل متعلم صغير ليتدرّب على اللغة الإنجليزية، ويلعب بثقة، ويستمتع بالتعلّم.",
  "Take the perfect penalty kick! Practise Present Simple and Past Simple through quick grammar challenges, goal celebrations, and friendly competition.": "سدّد ركلة الجزاء المثالية! تدرّب على المضارع البسيط والماضي البسيط من خلال تحديات قواعد سريعة واحتفالات بالأهداف ومنافسة ودية.",
  "How to Play": "طريقة اللعب",
  "Choose your level, then score your grammar goals!": "اختر مستواك ثم سجّل أهدافك في القواعد!",
  "Choose a level": "اختر المستوى",
  "Rookie, Pro, Champion, or Legend.": "Rookie أو Pro أو Champion أو Legend.",
  " — Rookie, Pro, Champion, or Legend.": " — Rookie أو Pro أو Champion أو Legend.",
  "Read and answer": "اقرأ وأجب",
  "choose the best grammar answer before time runs out.": "اختر أفضل إجابة نحوية قبل انتهاء الوقت.",
  " — choose the best grammar answer before time runs out.": " — اختر أفضل إجابة نحوية قبل انتهاء الوقت.",
  "Score goals": "سجّل الأهداف",
  "every correct answer earns points, stars, and rewards.": "كل إجابة صحيحة تمنحك نقاطًا ونجومًا ومكافآت.",
  " — every correct answer earns points, stars, and rewards.": " — كل إجابة صحيحة تمنحك نقاطًا ونجومًا ومكافآت.",
  "You have 20 seconds for every question.": "لديك 20 ثانية لكل سؤال.",
  "⏱ You have 20 seconds for every question.": "⏱ لديك 20 ثانية لكل سؤال.",
  "Present Simple": "المضارع البسيط",
  "Past Simple": "الماضي البسيط",
  "Primary 3–6": "من الصف الثالث إلى الصف السادس",
