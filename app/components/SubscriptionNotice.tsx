  ...
  return (
    <aside className="subscription-notice" dir="rtl" data-no-translate aria-label="محتوى المشتركين فقط">
      ...
      <div className="subscription-notice-copy">
        <strong>المحتوى متاح للمشتركين فقط</strong>
        <span>فعّل اشتراكك لفتح المناهج والألعاب وكتب التقييمات والبوكلتس الخاصة بمرحلتك.</span>
        <b>للاشتراك والاستفسار: 00966552019074</b>
      </div>
      <a className="subscription-whatsapp" href={WHATSAPP_URL} target="_blank" rel="noreferrer" aria-label="الاشتراك عبر واتساب">
