                ...
                <div className="curriculum-option english-option">
                  ...
                  <div className="curriculum-option-content">
                    ...
                    <div className="curriculum-terms" aria-label="Available terms">
                      <div className="curriculum-term"><strong>First Term</strong>{grade === 1 && <Link className="new-curriculum-entry" href="/courses/english-primary-1">Enter</Link>}{grade === 3 && <Link className="new-curriculum-entry" href="/courses/english-primary-3">Enter</Link>}{grade === 4 && <Link className="new-curriculum-entry" href="/courses/english-primary-4">Enter</Link>}{grade === 5 && <Link className="new-curriculum-entry" href="/courses/english-primary-5">Enter</Link>}{grade === 6 && <Link className="new-curriculum-entry" href="/courses/english-primary-6">Enter</Link>}</div>
